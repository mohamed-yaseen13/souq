...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( _Initial value)?  initial,TResult Function( DeleteAccountLoading value)?  loading,TResult Function( DeleteAccountSuccess value)?  success,TResult Function( DeleteAccountError value)?  error,required TResult orElse(),}){
final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial(_that);case DeleteAccountLoading() when loading != null:
return loading(_that);case DeleteAccountSuccess() when success != null:
return success(_that);case DeleteAccountError() when error != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( _Initial value)  initial,required TResult Function( DeleteAccountLoading value)  loading,required TResult Function( DeleteAccountSuccess value)  success,required TResult Function( DeleteAccountError value)  error,}){
final _that = this;
switch (_that) {
case _Initial():
return initial(_that);case DeleteAccountLoading():
return loading(_that);case DeleteAccountSuccess():
return success(_that);case DeleteAccountError():
return error(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( _Initial value)?  initial,TResult? Function( DeleteAccountLoading value)?  loading,TResult? Function( DeleteAccountSuccess value)?  success,TResult? Function( DeleteAccountError value)?  error,}){
final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial(_that);case DeleteAccountLoading() when loading != null:
...
switch (_that) {
case _Initial() when initial != null:
return initial();case DeleteAccountLoading() when loading != null:
return loading();case DeleteAccountSuccess() when success != null:
return success();case DeleteAccountError() when error != null:
...
switch (_that) {
case _Initial():
return initial();case DeleteAccountLoading():
return loading();case DeleteAccountSuccess():
return success();case DeleteAccountError():
return error(_that.message);case _:
  throw StateError('Unexpected subclass');
...
class DeleteAccountError implements DeleteAccountState {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DeleteAccountError&&(identical(other.message, message) || other.message == message));
}
...
/// @nodoc
abstract mixin class $DeleteAccountErrorCopyWith<$Res> implements $DeleteAccountStateCopyWith<$Res> {
